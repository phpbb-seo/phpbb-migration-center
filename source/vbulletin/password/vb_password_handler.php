...
/**
 * vBulletin Password Handler
 */
class vb_password_handler implements password_handler_interface
{
	/**
	...
	public function convert_password(string $scheme_class, $auth_data): array
	{
		...
		// Unknown/malformed format requires reset
		return [
			'hash'           => '',
			'type'           => 'unsupported',
			'requires_reset' => true,
	...
	/**
	 * Encode legacy vBulletin MD5 hash and salt into unambiguous storage format
	 *
