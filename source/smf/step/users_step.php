...
/**
 * SMF User Accounts Migration Step
 */
class users_step implements step_interface
{
	/** @var smf_user_normalizer */
	protected $normalizer;

	public function __construct(?smf_user_normalizer $normalizer = null)
	{
		$this->normalizer = $normalizer ?: new smf_user_normalizer();
	}
	...
	public function process_batch(
		...
		$tbl_users = $db->get_table_name('members');

		$sql = "SELECT * FROM {$tbl_users}
				WHERE id_member > {$cursor_id}
