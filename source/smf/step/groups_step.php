...
/**
 * SMF User Groups Migration Step
 */
class groups_step implements step_interface
{
	/** @var smf_group_normalizer */
	protected $normalizer;

	public function __construct(?smf_group_normalizer $normalizer = null)
	{
		$this->normalizer = $normalizer ?: new smf_group_normalizer();
	}
	...
	public function process_batch(
		...
		$tbl_groups = $db->get_table_name('membergroups');

		$sql = "SELECT * FROM {$tbl_groups}
				WHERE id_group > {$cursor_id}
