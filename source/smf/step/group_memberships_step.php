...
class group_memberships_step implements step_interface
{
	...
	public function process_batch(
		...
		$sql = "SELECT id_member, id_group, additional_groups
				FROM {$tbl_users}
		...
		foreach ($rows as $row)
		{
			...
			$is_admin = in_array(1, $all_groups, true);
			$is_mod = in_array(2, $all_groups, true) || in_array(3, $all_groups, true);
